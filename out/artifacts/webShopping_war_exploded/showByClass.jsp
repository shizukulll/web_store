   	...
   	<div ><h3>对不起，此类商品暂时为空！</h3>
    		...
    		<div class="prod_box">
	            ...
	            <div class="center_prod_box">
	                 ...
	                 <div class="product_img"><s:a href="CommodityAction!findCommodityById.action?commodity.commodityId=%{#commodityByClass.commodityId}"><img style="width: 168px" src="product/<s:property value='#commodityByClass.image' />"
	            ...
	            <a href="AddToCarAction?commodity.commodityId=<s:property value='#commodityByClass.commodityId'/>" title="header=[添加到购物车] body=[&nbsp;] fade=[on]"><img  src="js/images/cart.gif" alt="" title="" border="0" class="left_bt" /> </a>
